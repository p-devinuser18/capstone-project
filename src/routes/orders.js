...
router.get('/', (req, res) => {
  ...
  res.json({ statusCode: 200, data: uniqueProducts });
});
...
router.put('/:orderid', (req, res) => {
  ...
  res.json({ statusCode: 200, message: 'Order updated', order: orders[index] });
});
...
router.delete('/:orderid', (req, res) => {
  ...
  res.json({ statusCode: 200, message: 'Order deleted', order: deleted[0] });
});
